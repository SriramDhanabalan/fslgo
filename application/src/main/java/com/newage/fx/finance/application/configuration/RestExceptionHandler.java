...
//    MessageSource messageSource;
    ...
    public ResponseEntity<Object> handleServiceException(final ServiceException ex, final Locale locale) {

        log.info(ex.getClass().getName());
        String errorMessage = messageSource.getMessage(ex.getKey(), null, locale);
        final ResponseError error = new ResponseError(ex.getCode(), List.of(errorMessage));
        ResponseDTO responseError =  new ResponseDTO(HttpStatus.BAD_REQUEST.value(), Boolean.FALSE,null, error);
        return new ResponseEntity<>(responseError, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> handleDataIntegrityViolation(final DataIntegrityViolationException ex, final Locale locale) {

        log.info(ex.getClass().getName());

        final List<String> errorMessages = new ArrayList<>();
        String errorMessage = messageSource.getMessage(ServiceErrors.RECORD_DELETE_RESTRICTED.KEY, null, locale);
        errorMessages.add(errorMessage);

        final ResponseError error = new ResponseError(HttpStatus.BAD_REQUEST.getReasonPhrase(), errorMessages);
        ResponseDTO responseError =  new ResponseDTO(HttpStatus.BAD_REQUEST.value(), Boolean.FALSE,null, error);
        return new ResponseEntity<>(responseError, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
}
