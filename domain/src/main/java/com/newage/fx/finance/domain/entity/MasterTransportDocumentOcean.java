...
@Setter
@NoArgsConstructor
@Table(name = "master_transport_document_ocean")
public class MasterTransportDocumentOcean extends Auditable<String> {
...
//        public ShipmentHeader shipmentHeader;
    ...
    public MasterHeader masterHeader;
        ...
        @Column(name = "ftz_no", length = 100)
        private String FTZNo;

        @Column(name = "export_instruction", length = 300)
        private String exportInstruction;

        @Column(name = "ocean_carrier", length = 300)
        private String oceanCarrier;

        @Column(name = "terminal", length = 300)
        private String terminal;

        @Column(name = "pre_carriage")
        private Long preCarriage;

       @Column(name = "pre_carrier", length = 300)
       private String preCarrier;
        ...
        @OneToMany(mappedBy = "masterTransportDocumentOcean", cascade = CascadeType.ALL)
