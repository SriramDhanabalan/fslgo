...
/**
 * QEnquirySpotQuotation is a Querydsl query type for EnquirySpotQuotation
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QEnquirySpotQuotation extends EntityPathBase<EnquirySpotQuotation> {

    private static final long serialVersionUID = 224328950L;

    private static final PathInits INITS = new PathInits("*", "enquiryDetail.*.*");

    public static final QEnquirySpotQuotation enquirySpotQuotation = new QEnquirySpotQuotation("enquirySpotQuotation");
    ...
    public final StringPath filter_month = createString("filter_month");
    ...
    public QEnquirySpotQuotation(String variable) {
        this(EnquirySpotQuotation.class, forVariable(variable), INITS);
    }

    public QEnquirySpotQuotation(Path<? extends EnquirySpotQuotation> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEnquirySpotQuotation(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEnquirySpotQuotation(PathMetadata metadata, PathInits inits) {
        this(EnquirySpotQuotation.class, metadata, inits);
    }

    public QEnquirySpotQuotation(Class<? extends EnquirySpotQuotation> type, PathMetadata metadata, PathInits inits) {
