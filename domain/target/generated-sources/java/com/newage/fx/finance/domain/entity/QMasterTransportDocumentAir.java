...
/**
 * QMasterTransportDocumentAir is a Querydsl query type for MasterTransportDocumentAir
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QMasterTransportDocumentAir extends EntityPathBase<MasterTransportDocumentAir> {

    private static final long serialVersionUID = 1525308375L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QMasterTransportDocumentAir masterTransportDocumentAir = new QMasterTransportDocumentAir("masterTransportDocumentAir");
    ...
    public final EnumPath<com.newage.fx.finance.domain.enums.HawbStatus> mawbStatus = createEnum("mawbStatus", com.newage.fx.finance.domain.enums.HawbStatus.class);
    ...
    public QMasterTransportDocumentAir(String variable) {
        this(MasterTransportDocumentAir.class, forVariable(variable), INITS);
    }

    public QMasterTransportDocumentAir(Path<? extends MasterTransportDocumentAir> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QMasterTransportDocumentAir(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QMasterTransportDocumentAir(PathMetadata metadata, PathInits inits) {
        this(MasterTransportDocumentAir.class, metadata, inits);
    }

    public QMasterTransportDocumentAir(Class<? extends MasterTransportDocumentAir> type, PathMetadata metadata, PathInits inits) {
